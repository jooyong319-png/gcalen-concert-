...
- [x] 콘서트 전용 리서처 프롬프트 신규 작성(RESEARCHER_KO/EN/JA.md)
...
- [x] 콘텐츠 자동화 파이프라인(`PLANNER.md`) — 주 1회, 콘텐츠 신호 점검 전용
...
## 기획/개발 자동화(`PRODUCT_PLANNER.md`/`PRODUCT_DEVELOPER.md`)가 판단해서 진행할 것
